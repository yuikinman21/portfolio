    ...
    <div className="min-h-screen p-4 md:p-8 lg:p-12 max-w-[1400px] mx-auto space-y-10">
      ...
      <main className="grid grid-cols-1 md:grid-cols-6 lg:grid-cols-4 gap-4 md:gap-6 auto-rows-[minmax(180px,auto)]">
        ...
        <AnimatedBentoCard delay={0.4} className="md:col-span-3 lg:col-span-1 p-6 flex flex-col group h-full min-h-[400px]">
          ...
          >
            <div className="absolute inset-0 overflow-y-auto overflow-x-hidden px-2 pb-10 custom-scrollbar snap-y snap-mandatory">
              ...
              <motion.div
                ...
                className="snap-start p-3 my-4 mx-2 rounded-xl transition-all duration-300 hover:bg-green-50/50 hover:scale-[1.02] hover:shadow-[0_0_15px_rgba(168,85,247,0.3)] cursor-default border border-transparent hover:border-purple-200"
              >
                <TimelineItem
                  date="2026.04"
